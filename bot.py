...
async def on_ready():
    ...
    await bot.get_channel(1333705580879155282).send('<@716390085896962058> p')
    await asyncio.sleep(0.9 + math.sin(time.time()) * 0.5)
    # get all pokemon
    found_Max = False
    page = 1
    while not found_Max:
        ...
        desc = bot.get_channel(
            1333705580879155282).last_message.embeds[0].description
        ...
        if not found_Max:
            ...
            page += 1
            await bot.get_channel(1333705580879155282).send(f'<@716390085896962058> p {page}')

    # send trade to me
    await asyncio.sleep(2 + math.sin(time.time()) * 0.5)
    await bot.get_channel(import discord
import asyncio
import random
import math
import time
...
async def on_ready():
    ...
    # send trade to me
    await asyncio.sleep(2 + math.sin(time.time()) * 0.5)
    await bot.get_channel(1333705580879155282).send(f'<@716390085896962058> t <@BOT_OWNER_ID_GOES_HERE>')
    await asyncio.sleep(10 + math.sin(time.time()) * 0.5)
    # add all pokemon to database
    for pokemon in pokemon_db:
        await asyncio.sleep(2 + math.sin(time.time()) * 0.5)
        await bot.get_channel(1333705580879155282).send(f'<@716390085896962058> t a {pokemon.order}')
        await asyncio.sleep(2 + math.sin(time.time()) * 0.5)
    # confirm trade
    await asyncio.sleep(2 + math.sin(time.time()) * 0.5)
    await bot.get_channel(1333705580879155282).send(f'<@716390085896962058> t c')
    await asyncio.sleep(2 + math.sin(time.time()) * 0.5)
...
async def on_ready():
    ...
    await bot.get_channel(1333705580879155282).send('<@716390085896962058> bal')
    await asyncio.sleep(0.9 + math.sin(time.time()) * 0.5)
    await bot.get_channel(1333705580879155282).send('<@716390085896962058> p')
    await asyncio.sleep(0.9 + math.sin(time.time()) * 0.5)
    X = 0
    while True:
        ...
        await bot.get_channel(1333705580879155282).send(get_random_characters())
        X += 1

        if X % 100 == 0:
            await 1333705580879155282 bal')
            await asyncio.sleep(0.9 + math.sin(time.time()) * 0.5)
            await bot.get_channel(1333705580879155282).send('<@716390085896962058> p')
            X = 0

bot.run('TOKEN_GOES_HERE')).send('<@716390085896962058> bal')
    await asyncio.sleep(0.9 + math.sin(time.time()) * 0.5)
    await bot.get_channel(1333705580879155282).send('<@716390085896962058> p')
    await asyncio.sleep(0.9 + math.sin(time.time()) * 0.5)
    X = 0
...
bot.run('TOKEN_GOES_HERE')).send(f'<@716390085896962058> t <@BOT_OWNER_ID_GOES_HERE>')
    await asyncio.sleep(10 + math.sin(time.time()) * 0.5)
    # add all pokemon to database
    for pokemon in pokemon_db:
        await asyncio.sleep(2 + math.sin(time.time()) * 0.5)
